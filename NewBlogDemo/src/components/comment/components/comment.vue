    ...
    <div style="width: 100%;">
      ...
      <div style="margin-left: 50px;">
        ...
        <div v-if="!true" class="destop" style="font-size:13px;color: #9499A0;">
          ...
          <svg style="display:block;margin:4px 4px 0 25px;cursor: pointer;" t="1636093575017" class="icon hoverable2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3323" width="14px" height="14px">
          ...
          <svg style="display:block;margin:4px 4px 0 25px;cursor: pointer;" t="1636093991833" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4447" width="14px" height="14px">
            ...
            axios.post('/comment/addone/zan',{"comment_id":id,})
                .then(response=>{
                    if(response.data.code===0)Toast.fail(response.data.msg)
                        ...
                        Toast.success(response.data.data); 
                        this.scope_local.is_loved = !this.scope_local.is_loved   
