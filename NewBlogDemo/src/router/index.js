...
const routes = [
    ...
    },
    {
        ...
        meta: { title: '西巴BLOG -扫码授权' },

    },
    {
        path: '/wechatnow',
        name: 'wechatnow',
        meta: { title: '西巴BLOG -wechatnow' },
        redirect: 'login',
    },
    {
        path: '/alipay_account',
