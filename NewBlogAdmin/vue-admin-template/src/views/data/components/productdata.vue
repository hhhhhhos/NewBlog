<template>
  <div>
    <div style="display: flex;margin: 8px;">
      <span style="font-weight: bolder;margin: 0 0 0 0px;">商品名</span>
      <el-input v-model="fliter_name" @input="debouncedGetResults" style="width: 280px;margin-left: 20px;"></el-input>
    </div>
    <el-table
...
export default {
    ...
    created() {
        // 创建一个防抖函数，等待1秒后执行
        this.debouncedGetResults = debounce(this.input_event, 500);
    },
    watch:{
